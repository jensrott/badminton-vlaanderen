...
/* Template Name: Kleur blauw subpagina Klussce */
  ...
  <div id="page-container">
    <div id="content-wrap">
      ...
      <div class="grid-container">
        ...
        <div class="title_subpage">5.1 Klussce</div>
        ...
        <div class="wrapper">
          <button class="one color_blauw" onclick="location.href='kleur-blauw/klussce/agility-spurtestafettes/';">5.1.1 Agility – spurtestafettes</button>
          <button class="two color_blauw" onclick="location.href='kleur-blauw/klussce/rompstabiliteit/';">5.1.2 Rompstabiliteit</button>
          <button class="three color_blauw" onclick="location.href='kleur-blauw/klussce/snelheid/';">5.1.3 Snelheid</button>
